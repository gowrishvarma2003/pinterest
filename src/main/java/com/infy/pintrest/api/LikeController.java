...
public class LikeController {
    ...
    public ResponseEntity<String> unlikePin(@RequestParam Integer userId, @RequestParam Integer pinId) {
        return ResponseEntity.ok(likeService.unlikePin(userId, pinId));
    }
}
